(function () {
    ...
    app.controller('DonationsCtrl', ['$scope', '$http', 'campaigns', 'donations', function ($scope, $http, campaigns, donations) {
        ...
        $scope.nameHiddenToggle = function (donation) {
            ...
            $http.post('app/streamboard/set_donation_streamboard', {
                id: donation.id,
                property: 'nameHidden',
                value: donation.streamboard.nameHidden
            }).success(function () {

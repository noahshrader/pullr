...
<div class="dropdown avatar-container">
    <ul class="avatar-submenu right" role="menu" aria-labelledby="dropdownMenu1">
        <? if (Application::IsBackend()): ?>
            <li role="presentation"><a role="menuitem" href="admin/logout"><i class="icon mdi-communication-chat"></i>Logout</a></li>
        <? else: ?>
            <li role="presentation"><a role="menuitem" href="http://support.pullr.io" target="_blank"><i class="icon mdi-communication-chat"></i>Support</a></li>

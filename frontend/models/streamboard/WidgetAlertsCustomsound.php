 ...
 */
class WidgetAlertsCustomsound extends ActiveRecord {
    /**
     * @return string the name of the table associated with this ActiveRecord class.
     */
    public static function tableName() {
        return 'tbl_streamboard_widget_alerts_customsound';
    }
    ...
    public static function updateFromArray($data){
        ...
        WidgetAlertsCustomsound::deleteAll(['userId' => $userId, 'regionNumber' => $regionNumber]);
        $data = $data['donationCustomsound'];
        foreach($data as $row){
            $recode = new WidgetAlertsCustomsound();

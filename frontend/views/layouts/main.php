                    ...
                    <li class="add-campaign">
                        ...
                        <? if ($this->context->id == 'campaign'): ?>
                            <? if(\Yii::$app->user->identity->canCreateMoreCampaigns()): ?>
                                <a href="app/campaign/add" class="icon icon-plus-round" title="Add Campaign"></a>
                            <? else:?>
                                <a href="#" onclick="javascript:return false;" class="icon icon-plus-round" data-toggle="tooltip" data-placement="bottom" title="You have reached your active campaigns limit"></a>
                            <? endif;?>
                        <? endif ?>
                    </li>
                </ul>

                    ...
                    <li class="add-campaign">
                        ...
                        <? if ($this->context->id == 'campaigns'): ?>
                            <? if(\Yii::$app->user->identity->canCreateMoreCampaigns()): ?>
                                <a href="app/campaigns/add" class="mdi-content-add" title="Add Campaign"></a>
                            <? else:?>
                                <a href="#" onclick="javascript:return false;" class="mdi-content-add" data-toggle="tooltip" data-placement="bottom" title="You have reached your active campaigns limit"></a>
                            <? endif;?>
                        <? endif ?>
                    </li>
                </ul>

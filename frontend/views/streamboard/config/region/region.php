...
<div class="main-panel pane">
    <div class="settings-wrap">
        <div class="form-group">
            <h3>Region {{ region.regionNumber}} <input colorpicker="rgba" colorpicker-position="left" type="text" ng-model="region.backgroundColor" ng-change="regionChanged(region)" class="color-choice" ng-style="{'background-color':region.backgroundColor}"></h3>
        </div>

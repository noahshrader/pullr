...
<div class="panel-group media-item cf"
    ...
    <div class="mediaActions">
        <span class="custom-alert-sound" ng-if="preference.preferenceType =='donations'">
            <input  ng-model="customDonationSound.customsounds[region.regionNumber][file]" class="money-input" type="text" ng-show="moneybuttonclicked==1" ng-blur="moneybuttonclicked=0" focus-on="moneybuttonclicked"/>
            <i class="icon mdi-editor-attach-money"  ng-hide="moneybuttonclicked==1" ng-click="moneybuttonclicked=1">{{customDonationSound.customsounds[region.regionNumber][file]}}</i>
        </span>

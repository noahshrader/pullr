...
<div>
    <div class="module">
        ...
        <div class="panel-group">
            <h5>Font Color <input colorpicker="hex" colorpicker-position="left" colorpicker-with-input="true" type="text" ng-model="preference.fontColor" ng-change="regionChanged(region)" class="color-choice" ng-style="{'background-color':preference.fontColor}"></h5>
        </div>
    </div>
    <div class="module">
        <div class="panel-group">
...
<div class="module">
    <ul class="library-tabs cf">
        <li class="active"><a href="<?= Url::to() ?>#{{baseLink}}-sounds" data-toggle="tab"><i class="icon-volume-more"></i>Sounds</a></li>

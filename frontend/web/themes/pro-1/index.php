...
<html>
    <head>
        ...
        <!-- Theme Specific -->
        <link rel="stylesheet" href="/themes/pro-1/css/master.css" />
        <link rel="stylesheet" href="/themes/pro-1/css/animate.css" />
        <link rel="stylesheet" href="/themes/pro-1/css/owl.carousel.css" />
        <!-- Scripts -->
...
<div class="mc-hammer"><!-- Main Wrapper -->
<section class="stats">
<div class="container" ng-cloak>
	<div class="row feed-details">
		...
		<h1>{{campaign.name}}</h1>
		<date><span data-pullr='campaign-startDateFormatted' ng-cloak>{{campaign.startDateFormatted}}</span> - <span data-pullr='campaign-endDateFormatted'>{{campaign.endDateFormatted}}</span></date>
...
<div class="container">
	...
	<div class="row feed-meta">
		<div class="col-md-6 col-sm-6 col-xs-8 feed-meta-viewers">
			<p>100,001 viewers</p>
		</div>
			<div class="col-md-6 col-sm-6 col-xs-4 feed-details">
			<div class="sharing">
				<div class="dropdown">
...
<section class="charity-donors">
	<div class="user-details">
		<div class="col-md-12">
			...
			<p>Etiam porta sem malesuada magna mollis euismod. Donec id elit non mi porta gravida at eget metus. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi leo risus, porta ac consectetur ac, vestibulum at eros.</p>		
		</div>
	</div>
...
<footer>
	...
	<p>&copy; 2014 <? print(Date("Y")); ?> LLC</p>
	...
	<script type='text/javascript'>
        ...
        <script src="/themes/pro-1/js/owl.carousel.js"></script>
        <script src="/themes/pro-1/js/custom.js"></script>

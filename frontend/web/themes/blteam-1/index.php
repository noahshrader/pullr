    ...
    <div class="container" ng-cloak>
        ...
        <div class="col-md-6 col-sm-6 col-xs-8 feed-details">
            <div class="feed-details-title">
                ...
                <h3 ng-show='campaign.layoutType == LAYOUT_TYPE_TEAM' ng-cloak>{{selectedChannel.title}}</h3>
                <h5 ng-show='campaign.layoutType == LAYOUT_TYPE_TEAM' ng-cloak>{{selectedChannel.meta_game}}</h5>
            </div>
        </div>
    </div>
</section>

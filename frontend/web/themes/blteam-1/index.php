...
<head>
    ...
    <title>Pull - Team One Dark Theme</title>

    <link href="http://netdna.bootstrapcdn.com/bootstrap/3.2.0/css/bootstrap.min.css" rel="stylesheet">
    <link href="/themes/blteam-1/css/master.css" rel="stylesheet">
    <link href="/themes/blteam-1/css/animate.css" rel="stylesheet">
    <link href="/themes/blteam-1/css/owl.carousel.css" rel="stylesheet">
    <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.0/jquery.min.js"></script>
    <!--[if lt IE 9]>
    <script src="http://html5shiv.googlecode.com/svn/trunk/html5.js"></script><![endif]-->
    <script src="http://maxcdn.bootstrapcdn.com/bootstrap/3.2.0/js/bootstrap.min.js"></script>
    <script src="/themes/blteam-1/js/fitvids.js"></script>
                ...
                <div class="featuredstreamcontainer">
                    <div class="featuredstream">
                        <object type="application/x-shockwave-flash" height="378" width="620"
                                ...
                                data="http://www.twitch.tv/widgets/live_embed_player.swf?channel=funforfreedom"
                                bgcolor="#000000">
                            ...
                            <param name="flashvars"
                                   value="hostname=www.twitch.tv&amp;channel=funforfreedom&amp;auto_play=true&amp;start_volume=25"/>
                        </object>
                    </div>
                </div>
                <div class="featuredchat">
                    <iframe frameborder="0" scrolling="no" id="twitchChat"
                            src="http://twitch.tv/chat/embed?channel=funforfreedom&amp;popout_chat=true"></iframe>
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-md-6 col-sm-6">
                <div class="charity-info">
                    ...
                    <h4>St Judes Childrens Hospital</h4>
...
<footer>
    ...
    <p class="tandc"><a href="/terms">terms</a>|<a href="/privacy">privacy</a>|<a href="/flag"
                                                                                  class="icon-flag2 flag"></a></p>
</footer>
